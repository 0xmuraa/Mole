    ...
    <section id="terminal" className={styles.section}>
      <div className="container">
        <div className={styles.head}>
          <span className={styles.eyebrow}>SEISMIC OBSERVATORY</span>
          <h2 className={styles.headline}>THE TERMINAL IS WHERE EVERYTHING CONNECTS.</h2>
          <p className={styles.sub}>
            A preview of the full HYPERMOLE terminal. Every panel below is illustrative — the real
            product connects these views to live public Robinhood Chain data.
          </p>
        </div>
        ...
        <div className={styles.frame}>
          ...
          <div className={styles.mainGrid}>
            ...
            <div className={`${styles.panel} ${activeTab === "tremors" ? styles.panelActive : ""}`}>
              <div className={styles.panelLabelRow}>
                ...
                <span className={styles.miniTag}>DEMO</span>
              </div>
            ...
            <div className={`${styles.panel} ${activeTab === "decisions" ? styles.panelActive : ""}`}>
              <div className={styles.panelLabelRow}>
                ...
                <span className={styles.miniTag}>SIMULATION</span>
              </div>
          ...
          <div className={styles.bottomGrid}>
            <div className={`${styles.logPanel} ${activeTab === "logs" ? styles.panelActive : ""}`}>
              <div className={styles.panelLabelRow}>
                ...
                <span className={styles.miniTag}>ILLUSTRATIVE</span>
              </div>
            ...
            <div className={styles.logPanel}>
              <div className={styles.panelLabelRow}>
                ...
                <span className={styles.miniTag}>LIVE PREVIEW</span>
              </div>
          ...
          <div className={styles.footerRow}>
            <span className={styles.footerNote}>
              Simulated activity. Live public-chain integration comes later.
            </span>
